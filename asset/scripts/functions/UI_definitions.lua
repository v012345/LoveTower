...
function UIBox_button(args)
    ...
    args.colour = args.colour or Color.RED
    ...
    args.text_colour = args.text_colour or Color.UI.TEXT_LIGHT
    local but_UIT = args.col == true and UIT.C or UIT.R
        ...
        table.insert(but_UI_label,
            {
                ...
                nodes = {
                    { n = UIT.T, config = { text = v, scale = args.scale, colour = args.text_colour, shadow = args.shadow, focus_args = button_pip and args.focus_args or nil, func = button_pip, ref_table = args.ref_table } }
                }
            })
    end
