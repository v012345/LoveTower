...
---@overload fun(T: Transform, new_sprite_atlas: AtlasConfigItem, sprite_pos: {x: number, y: number, v?: number}, container: Node): AnimatedSprite
...
function AnimatedSprite:init(T, new_sprite_atlas, sprite_pos, container)
    Sprite.init(self, T, new_sprite_atlas, sprite_pos, container)
    self.offset = { x = 0, y = 0 }

    table.insert(App.ANIMATIONS, self)
